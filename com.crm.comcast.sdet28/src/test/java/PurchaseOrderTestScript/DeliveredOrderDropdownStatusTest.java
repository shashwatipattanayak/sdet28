...
public class DeliveredOrderDropdownStatusTest extends BaseClass{
/**
 * Purchase Order creation with status Delivered
 * @param args
 * @throws Throwable
 */
	@Test(groups = {"regressionTest"})
	public void deliveredOrder() throws Throwable {
	
		 //Get data from excel sheet
		 String expectedPurchaseName = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 9, 9);
		 String status = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 9, 2);
		 String subject = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 9, 3);
		 String vendorName = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 9, 4);
		 String billingAddress = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 9, 5);
		 String shippingAddress = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 9, 6);
		 String itemName = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 9, 7);
		 int quantity = (int) eUtil.getNumericCellData(IPathConstants.SHEET_NAME, 9, 8);
