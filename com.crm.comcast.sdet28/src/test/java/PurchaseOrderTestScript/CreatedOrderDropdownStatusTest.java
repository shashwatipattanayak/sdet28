...
public class CreatedOrderDropdownStatusTest extends BaseClass {
/**
 * Purchase Order creation with status Created
 * @param args
 * @throws Throwable
 */
	@Test(groups = {"smokeTest"})
	public void createdOrder() throws Throwable {
		 
		 //Get data from excel sheet
		 String expectedPurchaseName = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 6, 9);
		 String status = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 6, 2);
		 String subject = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 6, 3);
		 String vendorName = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 6, 4);
		 String billingAddress = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 6, 5);
		 String shippingAddress = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 6, 6);
		 String itemName = eUtil.getStringCellData(IPathConstants.SHEET_NAME, 6, 7);
		 int quantity = (int) eUtil.getNumericCellData(IPathConstants.SHEET_NAME, 6, 8);
